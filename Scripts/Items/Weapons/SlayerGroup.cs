...
namespace Server.Items
{
	...
	{
       /* private static string[] m_NameStrings = new string[]{
            "",
            "silver",
            "orc slaying",
            "troll slaughter",
        ...
        public static string SlayerNameToString(SlayerName name)
        {
            int idx = (int)name;

            if (idx >= 0 && idx < m_NameStrings.Length)
                return m_NameStrings[idx];
            else
                return "enchanted";
        }*/
