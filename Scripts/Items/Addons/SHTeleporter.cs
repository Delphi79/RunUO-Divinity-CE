...
namespace Server.Items
{
	...
	public class SHTeleporter : BaseAddon
	{
		...
		{
			World.Broadcast( 0x34, true, "Solen hives teleporters are being generated, please wait." );
			...
			World.Broadcast( 0x34, true, "{0} solen hives teleporters have been created. The entire process took {1:F1} seconds.", count, (endTime - startTime).TotalSeconds );
		}
