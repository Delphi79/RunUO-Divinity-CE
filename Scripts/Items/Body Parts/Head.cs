    ...
    public class Head : Item, ICarvable
	{
		...
		public void Carve(Mobile from, Item item)
		{
			...
			if ( m_PlayerName != null )
			{
                ...
                {
                    default:
                        str = String.Format(" of {0}", m_PlayerName);
                        break;
                    case HeadType.Duel:
                        str = String.Format(" of {0}, taken in a duel", m_PlayerName);
                        break;
                    case HeadType.Tournament:
                        str = String.Format(" of {0}, taken in a tournament", m_PlayerName);
                        break;
                }
			}

            brain.Name = "brain" + str;
            skull.Name = "skull" + str;
