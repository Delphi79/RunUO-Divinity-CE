...
namespace Server.Multis
{
    public class Tent : BaseHouse
	{
		public class TentChest : WoodenChest
		{
			...
			public TentChest( Tent owner, uint keyValue )
			{
				m_Tent = owner;
				KeyValue = keyValue;
				Locked = true;
			...
			{
                if (m_Tent != null && m_Tent.IsFriend(from) && from.InRange(this, 3))
                {
                    m_Tent.Visits++;
                    if (m_Tent.RefreshDecay())
                        from.SendMessage("Your tent's age and contents have been refreshed.");
                }
        ...
        public override bool CanPlaceNewBarkeep()
        {
            return false;
        }
        ...
        public override int DefaultPrice { get { return 16375; } }
        ...
        public override void ChangeSignType( int itemID )
        {
            base.ChangeSignType( itemID-1 );
        }
	...
	public class GuildHouse : BaseHouse
	{
		...
		public GuildHouse( Mobile owner ) : base( 0x74, owner, 150, 3 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class TwoStoryHouse : BaseHouse
	{
		...
		public TwoStoryHouse( Mobile owner, int id ) : base( id, owner, 200, 4 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class Tower : BaseHouse
	{
		...
		public Tower( Mobile owner ) : base( 0x7A, owner, 350, 7 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class Keep : BaseHouse//warning: ODD shape!
	{
		...
		public Keep( Mobile owner ) : base( 0x7C, owner, 550, 10 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class Castle : BaseHouse
	{
		...
		public Castle( Mobile owner ) : base( 0x7E, owner, 1000, 15 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class LargePatioHouse : BaseHouse
	{
		...
		public LargePatioHouse( Mobile owner ) : base( 0x8C, owner, 175, 3 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class LargeMarbleHouse : BaseHouse
	{
		...
		public LargeMarbleHouse( Mobile owner ) : base( 0x96, owner, 175, 4 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class SmallTower : BaseHouse
	{
		...
		public SmallTower( Mobile owner ) : base( 0x98, owner, 75, 3 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class LogCabin : BaseHouse
	{
		...
		public LogCabin( Mobile owner ) : base( 0x9A, owner, 75, 3 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class SandStonePatio : BaseHouse
	{
		...
		public SandStonePatio( Mobile owner ) : base( 0x9C, owner, 65, 3 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class TwoStoryVilla : BaseHouse
	{
		...
		public TwoStoryVilla( Mobile owner ) : base( 0x9E, owner, 125, 4 )
		{
			uint keyValue = CreateKeys( owner );
	...
	public class SmallShop : BaseHouse
	{
		...
		public SmallShop( Mobile owner, int id ) : base( id, owner, 25, 1 )
		{
			uint keyValue = CreateKeys( owner );
