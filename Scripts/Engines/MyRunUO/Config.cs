...
namespace Server.Engines.MyRunUO
{
	public class Config
	{
		...
		// Details required for database connection string
			...
			public static string DatabaseName			= "divinityce_myrunuo";
        	public static string DatabaseUserID         = "divinityce_user";
        	public static string DatabasePassword       = "divinityce_password";
