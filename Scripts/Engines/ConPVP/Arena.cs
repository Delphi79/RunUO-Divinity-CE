...
namespace Server.Engines.ConPVP
{
	public class ArenaController : Item
	{
		...
		public static ArrayList Instances{ get{ return m_Instances; } set{ m_Instances = value; } }
	}
	...
	public class Arena : IComparable
	{
		...
		private static ArrayList m_Arenas = new ArrayList();

		public static ArrayList Arenas{ get{ return m_Arenas; } }
		...
		public static Arena FindArena()
		{
			...
			for ( int i = 0; i < m_Arenas.Count; ++i )
			{
				Arena arena = (Arena)m_Arenas[(i + offset) % m_Arenas.Count];

				if ( !arena.IsOccupied )
					return arena;
			}

			return (Arena)m_Arenas[offset];
		}
