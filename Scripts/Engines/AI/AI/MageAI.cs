...
namespace Server.Mobiles
{
	public class MageAI : BaseAI
	{
		...
		public virtual Spell GetRandomDamageSpell( bool canDispel )
		{
			...
			while ( maxCircle > 1 && MagerySpell.m_ManaTable[maxCircle-1] > (m_Mobile.Mana/2) )
				maxCircle--;
		...
		public Mobile FindDispelTarget( bool activeOnly )
		{
			...
			if ( activeOnly )
			{
				List<Server.AggressorInfo> aggressed = m_Mobile.Aggressed;
                List<Server.AggressorInfo> aggressors = m_Mobile.Aggressors;
