		...
		public void CompleteCraft( int quality, bool makersMark, Mobile from, CraftSystem craftSystem, Type typeRes, BaseTool tool, CustomCraft customCraft )
		{
			...
			if ( CheckSkills( from, typeRes, craftSystem, ref ignored, ref allRequiredSkills ) )
			{
				...
				if ( item != null )
				{
					...
					bool CreateMagicArmor = true;
					bool CreateMagicWeapon = true;

					if ( CreateMagicArmor && item is BaseArmor )
					{
						BaseArmor armor = (BaseArmor)item;

						if ( armor.Hue == 2219 ) // Valorite
							armor.Durability = ArmorDurabilityLevel.Indestructible;
						else if ( armor.Hue == 2207 ) // Verite
							armor.Durability = ArmorDurabilityLevel.Fortified;
						else if ( armor.Hue == 2425 ) // Agapite
							armor.Durability = ArmorDurabilityLevel.Massive;
						else if ( armor.Hue == 2213 ) // Gold
							armor.Durability = ArmorDurabilityLevel.Substantial;
						else if ( armor.Hue == 2418 ) // Bronze
							armor.Durability = ArmorDurabilityLevel.Durable;
						else if ( armor.Hue == 2413 ) // Copper
							armor.Durability = ArmorDurabilityLevel.Durable;
						else if ( armor.Hue == 2406 ) // Shadow
							armor.Durability = ArmorDurabilityLevel.Durable;
						else if ( armor.Hue == 2419 ) // DullCopper
					...
					else if ( CreateMagicWeapon && item is BaseWeapon )
					{
						BaseWeapon weapon = (BaseWeapon)item;

						if ( weapon.Hue == 2219 ) // Valorite
							weapon.DurabilityLevel = WeaponDurabilityLevel.Indestructible;
						else if ( weapon.Hue == 2207 ) // Verite
							weapon.DurabilityLevel = WeaponDurabilityLevel.Fortified;
						else if ( weapon.Hue == 2425 ) // Agapite
							weapon.DurabilityLevel = WeaponDurabilityLevel.Massive;
						else if ( weapon.Hue == 2213 ) // Gold
							weapon.DurabilityLevel = WeaponDurabilityLevel.Substantial;
						else if ( weapon.Hue == 2418 ) // Bronze
							weapon.DurabilityLevel = WeaponDurabilityLevel.Durable;
						else if ( weapon.Hue == 2413 ) // Copper
							weapon.DurabilityLevel = WeaponDurabilityLevel.Durable;
						else if ( weapon.Hue == 2406 ) // Shadow
							weapon.DurabilityLevel = WeaponDurabilityLevel.Durable;
						else if ( weapon.Hue == 2419 ) // DullCopper
