	...
	public class HelpGump : Gump
	{
		...
		public HelpGump( Mobile from ) : base( 0, 0 )
		{
			...
			if ( isYoung )
			{
				...
				AddHtml(110, 270, 450, 58, @"<u>Another player is harassing me.</u> Another player is verbally harassing your character. When you select this option you will be sending a text log to Origin Systems. To see what constitutes harassment please read the rules at https://github.com/msturgill/divinity.", true, true);

				AddButton( 80, 335, 5540, 5541, 0, GumpButtonType.Page, 2 );
				AddHtml( 110, 335, 450, 58, @"<u>Other.</u> If you are experiencing a problem in the game that does not fall into one of the other categories, please use this option.", true, true );
			}
			else
			{
				...
				AddHtml(110, 250, 450, 74, @"<u>Another player is harassing me.</u> Another player is verbally harassing your character. When you select this option you will be sending a text log to Origin Systems. To see what constitutes harassment please read the rules on https://github.com/msturgill/divinity.", true, true);

				AddButton( 80, 330, 5540, 5541, 0, GumpButtonType.Page, 2 );
				AddHtml( 110, 330, 450, 74, @"<u>Other.</u> If you are experiencing a problem in the game that does not fall into one of the other categories, please use this option.", true, true );
			}
			...
			AddHtml(110, 170, 450, 74, @"<u>Suggestion for the Game.</u> If you'd like to make a suggestion for the game, it should be directed to the Development Team Members who participate in the discussion forums on the https://github.com/msturgill/divinity web site. Choosing this option will take you to the Discussion Forums. ", true, true);
			...
			AddHtml( 110, 330, 450, 74, @"<u>Other.</u> If you are experiencing a problem in the game that does not fall into one of the other categories, and requires in-game assistance, use this option. ", true, true );
