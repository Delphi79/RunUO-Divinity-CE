...
namespace Server.Mobiles
{
	public abstract class BaseGuard : Mobile
	{
        ...
        private bool _NoIdleTimeout = false;
		...
		public BaseGuard( Mobile target )
		{
            ...
            Skills[SkillName.Forensics].Base = 100;
            Skills[SkillName.Wrestling].Base = 100;
            Skills[SkillName.Fencing].Base = 100;
            Skills[SkillName.Macing].Base = 100;
            Skills[SkillName.Swords].Base = 100;
            Skills[SkillName.DetectHidden].Base = 100;
            Skills[SkillName.Archery].Base = 100;
            Skills[SkillName.Parry].Base = 100;
            Skills[SkillName.Tactics].Base = 100;
            Skills[SkillName.MagicResist].Base = 100;
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            switch (version)
            {
                case 0:
                    ...
                    _NoIdleTimeout = reader.ReadBool();
