...
namespace Server.Mobiles
{
	public class GenericBuyInfo : IBuyItemInfo
	{
		...
		private IEntity m_DisplayEntity;
                private bool m_Always999 = false;
        ...
        public GenericBuyInfo(int name, Type type, int price, int amount, int itemID, int hue)
            : this(name.ToString(), type, price, amount, itemID, hue, null)
        {
        }
