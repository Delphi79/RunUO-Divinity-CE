	...
	{ 
		...
		{ 
			...
			{ 
				...
				Add( new GenericBuyInfo( typeof( SackFlour ), 12, 20, 0x1039, 0 ) );
				...
				Add( new GenericBuyInfo( "1044567", typeof( Skillet ), 12, 20, 0x97F, 0 ) );
