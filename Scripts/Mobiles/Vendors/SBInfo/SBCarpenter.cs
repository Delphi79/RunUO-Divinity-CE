...
namespace Server.Mobiles
{
	public class SBCarpenter: SBInfo
	{
		...
		public class InternalBuyInfo : ArrayList
		{
			...
			{
                Add(new GenericBuyInfo("1041280", typeof(InteriorDecorator), 50000, 20, 0xFC1, 0));
				...
				Add( new GenericBuyInfo( typeof( Hammer ), 6, 20, 0x102A, 0 ) );
		...
		public class InternalSellInfo : GenericSellInfo
		{
			...
			{
                Add(typeof(InteriorDecorator), 25000);
