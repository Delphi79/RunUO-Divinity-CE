...
namespace Server.Mobiles
{
	public class RealEstateBroker : BaseVendor
	{
		...
		public int ComputePriceFor( HouseDeed deed )
		{
            ...
            if ( deed is BlueTentDeed || deed is GreenTentDeed )
                price = 16375;
			else if ( deed is SmallBrickHouseDeed || deed is StonePlasterHouseDeed || deed is FieldStoneHouseDeed || deed is SmallBrickHouseDeed || deed is WoodHouseDeed || deed is WoodPlasterHouseDeed || deed is ThatchedRoofCottageDeed )
				price = 43800;
			...
			return AOS.Scale( price, 90 ); // refunds 90% of the purchase price
		}
