...
namespace Server.Mobiles
{
	...
	public class Nightmare : BaseMount
	{
		...
		[Constructable]
		public Nightmare( string name ) : base( name, 0x74, 0x3EA7, AIType.AI_Mage, FightMode.Closest, 12, 1, 0.5, 0.75 )
		{
			BaseSoundID = 0xA8;
			...
			SetSkill( SkillName.EvalInt, 70, 80.0 );
            SetSkill(SkillName.Magery, 70, 80.0);
            SetSkill(SkillName.Meditation, 70, 80.0);
