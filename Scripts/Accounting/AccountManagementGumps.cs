		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			else
			{
				try
				{
					...
					//MailMessage mm = new MailMessage( "Divinity CE Account Manager <noreply@runuo.com>", email );
					MailMessage mm = new MailMessage( new MailAddress( "noreply@runuo.com", "Divinity CE Account Manager" ), new MailAddress( email ) );
	...
	public class ChangePasswordGump : Gump
	{
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			else
			{
				...
				//MailMessage mm = new MailMessage( "Divinity CE Account Manager <noreply@runuo.com>", email );
                MailMessage mm = new MailMessage(new MailAddress("noreply@runuo.com", "Divinity CE Account Manager"), new MailAddress(email, m_Mobile.Name));
				mm.Subject = "Divinity CE Account Management";
				mm.Body = String.Format(
