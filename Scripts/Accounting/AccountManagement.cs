...
namespace Server.Accounting
{
	public class AccountManagement
	{
		...
		public static void Initialize()
		{
			...
			Server.Commands.CommandSystem.Register( "Account", AccessLevel.Player, new CommandEventHandler( Command_Account ) );
            Server.Commands.CommandSystem.Register("Auth", AccessLevel.Player, new CommandEventHandler(Command_Register));
		}

		[Usage( "Account" )]
		[Description( "Allows a player to manage their account settings." )]
		public static void Command_Account( CommandEventArgs e )
		{
			Mobile m = e.Mobile;
		...
		public static void Command_Register( CommandEventArgs e )
		{
			Mobile m = e.Mobile;
