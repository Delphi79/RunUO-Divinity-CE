...
namespace Server
{
    ...
    public class PoisonImpl : Poison
    {
        ...
        public static void Configure()
        {
            /*
             Name:		Name of poison.
             Level:		Level of poison.
             Scalar:	Percentage of hits points dealt as damage per "hit".
             Interval:	Number of seconds between each "hit".
			 
            */
            //                             Name, Level, Scalar, Interval, 
            Register(new PoisonImpl("Lesser", 0, 0.05, 15.0));
            Register(new PoisonImpl("Regular", 1, 0.0667, 10.0));
            Register(new PoisonImpl("Greater", 2, 0.125, 10.0));
            Register(new PoisonImpl("Deadly", 3, 0.25, 5.00));
            Register(new PoisonImpl("Lethal", 4, 0.50, 5.00));
        }

        public static new PoisonImpl Parse(string name)
        {
            return Poison.Parse(name) as PoisonImpl;
        }
        ...
        public class PoisonTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                m_Mobile.Damage(m_LastDamage + 1, m_Mobile);
