	...
	public class NotorietyHandlers
	{
			...
			if( c != null )
			{
                ...
                else
                {
                    if ( c.ControlMaster != null )
                        g = c.ControlMaster.Guild as Guild;
                    if ( c.SummonMaster != null)
                        g = c.SummonMaster.Guild as Guild;
                }
			}
		...
		public static int CorpseNotoriety( Mobile source, Corpse target )
		{
			...
			else
			{
                ...
                if ( (target.TimeOfDeath + Corpse.PlayerLootRightSacrifice) <= DateTime.Now )
                    return Notoriety.CanBeAttacked;
