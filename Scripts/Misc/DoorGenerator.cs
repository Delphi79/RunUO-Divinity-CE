...
namespace Server
{
	public class DoorGenerator
	{
		...
		{
			World.Broadcast( 0x34, true, "Generating doors, please wait." );
			...
			World.Broadcast( 0x34, true, "Door generation complete. Trammel: {0}; Felucca: {1}; Ilshenar: {2}; Malas: {3};", trammelCount, feluccaCount, ilshenarCount, malasCount );
		}
