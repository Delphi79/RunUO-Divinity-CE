...
namespace Server
{
	public class LootPack
	{
        ...
        public static readonly LootPackItem[] ClothingItems = new LootPackItem[]
			{
        ...
        public static readonly LootPackItem[] FoodItems = new LootPackItem[]
            {
                new LootPackItem( typeof( Food ), 5 ),
                new LootPackItem( typeof( BaseBeverage ), 3 ),
        ...
        private static readonly LootPackItem[] BootItems = new LootPackItem[]
			{
				new LootPackItem( typeof( ThighBoots ), 1 ),
				new LootPackItem( typeof( Boots ), 1 ),
			};
        ...
        private static readonly LootPackItem[] MissleItems = new LootPackItem[]
			{
				new LootPackItem( typeof( Arrow ), 2 ),
		...
		public static readonly LootPackItem[] OldMagicItems = new LootPackItem[]
			{
				new LootPackItem( typeof( BaseArmor ), 10 ),
				new LootPackItem( typeof( BaseWeapon ), 10 ),
                new LootPackItem( typeof( BaseShield ), 4 ),
        ...
        public static readonly LootPack MagicWeapons = new LootPack(new LootPackEntry[]
			{
                new LootPackEntry( false, new LootPackItem[]{ new LootPackItem( typeof( BaseWeapon ), 1 ), },  100.00, 1, 1, 0, 75 )
			});
        ...
        public static readonly LootPack OldPoor = new LootPack(new LootPackEntry[]
			{
				...
				new LootPackEntry( false, FoodItems,	 50.00, 1 ),
				new LootPackEntry( false, ClothingItems,1.00, 1, 1, 0, 1 ),

				new LootPackEntry( false, BootItems,	 25.00, 1 ),
				new LootPackEntry( false, LightSources, 25.00, 1 ),
        ...
        public static readonly LootPack OldMeager = new LootPack(new LootPackEntry[]
			{
				new LootPackEntry( true,  Gold,		100.00, "5d10+30" ),
				new LootPackEntry( false, FoodItems,	 50.00, 1 ),
				new LootPackEntry( false, ClothingItems,1.00, 1, 1, 0, 50 ),

				new LootPackEntry( false, PotOrReag,	 25.00, "2d3" ),
				new LootPackEntry( false, MissleItems,  40.00, "5d3" ),
				new LootPackEntry( false, LowScrollItems,5.00, 1 ),

				//new LootPackEntry( false, OldMagicItems,	  1.00, 1, 1, 0, 30 ),
				new LootPackEntry( false, OldMagicItems,	  5.00, 1, 1, 0, 35 ),

				new LootPackEntry( false, Jewelry,		  0.50, 1, 1, 0, 60 ),
        ...
        public static readonly LootPack OldAverage = new LootPack(new LootPackEntry[]
			{
				new LootPackEntry( true, Gold,		100.00, "5d5+125" ),
				new LootPackEntry( false, FoodItems,	 50.00, "1d2" ),
				new LootPackEntry( false, ClothingItems,2.00, 1, 1, 1, 75 ),

				new LootPackEntry( false, PotOrReag,	 50.00, "2d3" ),
				new LootPackEntry( false, MissleItems,  50.00, "5d3" ),
				new LootPackEntry( false, MedScrollItems,25.00, 1 ),
				new LootPackEntry( false, GemItems,	 20.00, 1 ),
				
				new LootPackEntry( false, OldMagicItems,	  5.75, 1, 1, 5, 30 ),
				new LootPackEntry( false, OldMagicItems,	  3.00, 1, 1, 15, 66 ),
				//new LootPackEntry( false, OldMagicItems,	  0.45, 1, 1, 10, 45 ),

				new LootPackEntry( false, Jewelry,		  0.75, 1, 1, 5, 65 ),
        ...
        public static readonly LootPack OldRich = new LootPack(new LootPackEntry[]
			{
				new LootPackEntry( true, Gold,		100.00, "5d10+200" ),
				new LootPackEntry( false, FoodItems,	 50.00, 2 ),
				new LootPackEntry( false, ClothingItems,2.00, 1, 1, 10, 100 ),

				new LootPackEntry( false, PotOrReag,	 50.00, "2d3" ),
				new LootPackEntry( false, MissleItems,  50.00, "5d3" ),
				new LootPackEntry( false, HighScrollItems,25.00, 1 ),
				new LootPackEntry( false, GemItems,	 33.00, 1 ),

				new LootPackEntry( false, OldMagicItems,	  10.00, 1, 1,  5, 35 ),
				//new LootPackEntry( false, OldMagicItems,	  0.65, 1, 1, 10, 50 ),
				//new LootPackEntry( false, OldMagicItems,	  0.45, 1, 1, 10, 60 ),
				new LootPackEntry( false, OldMagicItems,	  3.00, 1, 1, 10, 79 ),

				new LootPackEntry( false, Jewelry,		  1.50, 1, 1, 0, 70 ),
        ...
        public static readonly LootPack OldFilthyRich = new LootPack(new LootPackEntry[]
			{
				...
				new LootPackEntry( false, PotOrReag,	 50.00, "2d3" ),
				new LootPackEntry( false, MissleItems,  50.00, "3d5" ),
				new LootPackEntry( false, HighScrollItems,33.00, 1 ),
				new LootPackEntry( false, GemItems,	 50.00, 1 ),
				new LootPackEntry( false, GemItems,	 25.00, 1 ),
				new LootPackEntry( false, Jewelry,		 1.50, 1, 1, 25, 100 ),
				new LootPackEntry( false, ClothingItems,3.00, 1, 1, 25, 100 ),
				new LootPackEntry( false, Instruments,	  1.00, 1 ),

				new LootPackEntry( false, OldMagicItems,	  10.00, 1, 1, 5, 35 ),
				//new LootPackEntry( false, OldMagicItems,	  7.50, 1, 1, 5, 55 ),
				//new LootPackEntry( false, OldMagicItems,	  5.00, 1, 1, 10, 75 ),
				new LootPackEntry( false, OldMagicItems,	  8.50, 1, 1, 20, 80 ),
				new LootPackEntry( false, OldMagicItems,	  2.50, 1, 1, 30, 89 ),
			});

        public static readonly LootPack OldUltraRich = new LootPack(new LootPackEntry[]
			{
                new LootPackEntry( false, FoodItems,         50.00, 2 ),
                new LootPackEntry( false, ClothingItems,      4.00, 1, 1, 1, 100 ),
                //new LootPackEntry( false, ClothingItems,      5.00, 1, 1,  1, 50 ),
				new LootPackEntry(  true, Gold,			100.00, "3d100+500" ),
				new LootPackEntry( false, Instruments,	  1.00, 1 ),
                new LootPackEntry( false, Jewelry,		 7.50, 1, 1, 25, 100 ),
                new LootPackEntry( false, Jewelry,		 7.50, 1, 1, 25, 100 ),

				new LootPackEntry( false, OldMagicItems,  15.00, 1, 1, 5, 35 ),
				new LootPackEntry( false, OldMagicItems,  7.25, 1, 1, 20, 60 ),
				new LootPackEntry( false, OldMagicItems,  3.50, 1, 1, 25, 89 ),
				new LootPackEntry( false, OldMagicItems,  0.45, 1, 1, 40, 100 ),
			});

        public static readonly LootPack OldSuperBoss = new LootPack(new LootPackEntry[]
			{
                new LootPackEntry( false, FoodItems,         75.00, "1d2+2" ),
                new LootPackEntry( false, ClothingItems,      15.00, 1, 1, 25,  100 ),
                //new LootPackEntry( false, ClothingItems,      5.00, 1, 1, 1, 100 ),
				new LootPackEntry(  true, Gold,			100.00, "3d100+550" ),
				new LootPackEntry( false, Instruments,	  2.00, 1 ),
                new LootPackEntry( false, Jewelry,		 7.50, 1, 1, 25, 100 ),
                new LootPackEntry( false, Jewelry,		 7.50, 1, 1, 25, 100 ),
                new LootPackEntry( false, Jewelry,		 7.50, 1, 1, 25, 100 ),

				new LootPackEntry( false, OldMagicItems,  50.00, 1, 1, 5,  75 ),
				new LootPackEntry( false, OldMagicItems,  15.00, 1, 1, 5, 75 ),
				new LootPackEntry( false, OldMagicItems,  8.50, 1, 1, 25, 89 ),
				new LootPackEntry( false, OldMagicItems,  0.95, 1, 1, 45, 100 ),
			});

		/*public static readonly LootPack OldPoor = new LootPack( new LootPackEntry[]
			{
                new LootPackEntry( false, Foods,         50.00, 1 ),
                new LootPackEntry( false, Clothing,      25.00, 1 ),
		...
		public static readonly LootPack OldMeager = new LootPack( new LootPackEntry[]
			{
                new LootPackEntry( false, Foods,         50.00, 1 ),
                new LootPackEntry( false, Clothing,      50.00, 1, 1, 0, 25 ),
		...
		public static readonly LootPack OldAverage = new LootPack( new LootPackEntry[]
			{
                new LootPackEntry( false, Foods,         50.00, "1d2" ),
                new LootPackEntry( false, Clothing,      75.00, 1, 1, 0, 50 ),
		...
		public static readonly LootPack OldRich = new LootPack( new LootPackEntry[]
			{
                new LootPackEntry( false, Foods,         50.00, 2 ),
                new LootPackEntry( false, Clothing,      50.00, 1, 1, 25, 100 ),
                new LootPackEntry( false, Clothing,      75.00, 1, 1,  0, 75 ),
		...
		public static readonly LootPack OldFilthyRich = new LootPack( new LootPackEntry[]
			{
                new LootPackEntry( false, Foods,         75.00, "1d2+2" ),
                new LootPackEntry( false, Clothing,      75.00, 1, 1, 0,  100 ),
                new LootPackEntry( false, Clothing,      75.00, 1, 1, 50, 100 ),
				new LootPackEntry(  true, Gold,			100.00, "2d125+400" ),
				new LootPackEntry( false, Instruments,	  2.00, 1 ),
		...
		public static readonly LootPack OldUltraRich = new LootPack( new LootPackEntry[]
			{
                new LootPackEntry( false, Clothing,     50.00, 1, 1, 50, 100 ),
                new LootPackEntry( false, Clothing,     75.00, 1, 1, 25, 100 ),
                new LootPackEntry( false, Clothing,     100.00, 1, 1, 0, 100 ),
                new LootPackEntry( false, Foods,        100.00, "2d3" ),
				new LootPackEntry(  true, Gold,			100.00, "5d100+500" ),
				new LootPackEntry( false, Instruments,	  2.00, 1 ),
		...
		public static readonly LootPack OldSuperBoss = new LootPack( new LootPackEntry[]
			{
				new LootPackEntry( false, Clothing,     75.00, 1, 1, 75, 100 ),
                new LootPackEntry( false, Clothing,     90.00, 1, 1, 50, 100 ),
                new LootPackEntry( false, Clothing,     100.00,1, 1, 25, 100 ),
                new LootPackEntry( false, Foods,        100.00, "3d3" ),
				new LootPackEntry(  true, Gold,			100.00, "5d100+500" ),
				new LootPackEntry( false, Instruments,	  2.00, 1 ),
				new LootPackEntry( false, OldMagicItems,	100.00, 1, 1, 40, 100 ),
				new LootPackEntry( false, OldMagicItems,	100.00, 1, 1, 40, 100 ),
