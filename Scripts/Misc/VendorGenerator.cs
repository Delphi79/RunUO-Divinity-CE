...
namespace Server
{
	public class VendorGenerator
	{
		...
		private static void Process( Map map, Rectangle2D[] regions )
		{
			...
			World.Broadcast( 0x34, true, "Generating vendor spawns for {0}, please wait.", map );
			...
			World.Broadcast( 0x34, true, "Generation complete. {0} spawners generated.", m_ShopList.Count );
		}
