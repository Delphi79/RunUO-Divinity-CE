...
namespace Server
{
	public class Loot
	{
        ...
        private static Type[] m_FoodTypes = new Type[]
			{
				typeof( BreadLoaf ), typeof( CheeseWedge ), typeof( CheeseWheel ),
			};

        public static Type[] FoodTypes { get { return m_FoodTypes; } }

        private static Type[] m_Drinks = new Type[]
			{
				typeof( BeverageBottle )
			};

        public static Type[] DrinkTypes { get { return m_Drinks; } }
		...
		{
            return Construct(m_WandTypes) as MagicWand;
		}
        ...
        {
            return Construct(m_FoodTypes) as Food;
        }

        public static BaseBeverage RandomDrink()
        {
            //return Construct(m_DrinkTypes) as BaseBeverage;
            return new BeverageBottle((BeverageType)Utility.Random(((int)BeverageType.Water) + 1));
        }
