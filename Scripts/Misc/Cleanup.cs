...
namespace Server.Misc
{
	public class Cleanup
	{
		...
		public static void Run()
		{
			...
			{
				if ( boxes > 0 )
					Console.WriteLine( "Cleanup: Detected {0} inaccessible items, including {1} bank boxes ({2} of which were empty), removing..", items.Count, boxes, emptyBoxes );
				else
