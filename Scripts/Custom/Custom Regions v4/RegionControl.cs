...
//---------------------------- Solaris Battlegrounds addition (1/3) begin ----------------------------------------------------
...
*/
		...
		{
			get{ return _Battlegrounds; }
			set{ _Battlegrounds = value; }
		}
//--------------------------- Solaris Battlegrounds addition (1/3) end ------------------------------------------------------
...
*/
        ...
        public override void Serialize( GenericWriter writer )
		{
			...
			//NOTE:  number increased from 5 to 6 to allow for Solaris Battlegrounds addition
			writer.Write( (int) 6 ); // version
			
//---------------------------- Solaris Battlegrounds addition (2/3) begin ----------------------------------------------------

/*  This allows region controllers to be used to define "battlegrounds" where player versus player combat is completely no-holds-barred.
There is no notoriety problems like criminal/murder status, and is intended for PVP tourneys or all-around-PVP fun.

*/
			writer.Write( _Battlegrounds );
//--------------------------- Solaris Battlegrounds addition (2/3) end ------------------------------------------------------
