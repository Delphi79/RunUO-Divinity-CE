...
public class ViewItemGump : Gump
{
        ...
        : base(0, 0)
    {
        ...
        if (m.AccessLevel > AccessLevel.Administrator) //GM capabilities
        {
            if (!viewItem)
                AddLabel(363, 216, 2123, r.Title);
            else
...
public class DisplayBox : LargeCrate, IEnumerable
{
    ...
    public void DisplayTo(Mobile m, Reward r)
    {
        ...
        bool staff = m.AccessLevel >= AccessLevel.Developer;
...
public class ClassicVendorGump : Gump, IRewardVendorGump
{
    ...
    public ArrayList RewardList { get { return m_List; } }
...
public class PaymentTarget : Target
{
    ...
    //by item property
    public PaymentTarget(IRewardVendor vendor, string propName) : this()
    {
        m_Vendor = vendor;
