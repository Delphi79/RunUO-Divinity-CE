                ...
                if (targeted is BaseWeapon)
                {
                    if (from.CheckTargetSkill(SkillName.ArmsLore, targeted, 0, 100))
                    {
                        ...
                        if (weap.MaxHitPoints != 0)
                        {
                            ...
                            if (weap.MaxHitPoints < 10)
                            {
                                from.SendAsciiMessage(0x25,"This weapon is old and worn, even with repair it will not last much longer.");
                            }
                        }
                ...
                else if (targeted is BaseArmor)
                {
                    if (from.CheckTargetSkill(SkillName.ArmsLore, targeted, 0, 100))
                    {
                        ...
                        if (arm.MaxHitPoints != 0)
                        {
                            ...
                            if (arm.MaxHitPoints < 10)
                            {
                                from.SendAsciiMessage(0x25,"This armor is old and worn, even with repair it will not last much longer.");
                            }
                        }
