...
namespace Server.SkillHandlers
{
    public class Tracking
    {
        ...
        private class TrackingMenu : ItemListMenu
        {
            ...
            public TrackingMenu()
                : base("What do you wish to track?", m_Categories)
            {
            }
        ...
        private class TrackingList : ItemListMenu
        {
            ...
            public TrackingList(ArrayList list)
                : base("What would you like to track?", MakeItemList(list))
            {
                m_List = list;
            }
        ...
        private class TrackingTimer : Timer
        {
            ...
            public TrackingTimer(Mobile track, Mobile from)
                : base(TimeSpan.Zero, TimeSpan.FromSeconds(1), 150)
            {
                m_ToTrack = track;
                m_From = from;
