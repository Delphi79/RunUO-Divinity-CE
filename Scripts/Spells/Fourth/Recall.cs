...
/*			else if ( Caster.Criminal )
            ...
            return SpellHelper.TravelInsideT2A(Caster) || SpellHelper.CheckTravel(Caster, TravelCheckType.RecallFrom);
		}
		...
		public void Effect( Point3D loc, Map map, bool checkMulti )
		{
			...
			else if ( !t2aOK && !SpellHelper.CheckTravel( Caster, TravelCheckType.RecallFrom ) )
			{
			}
			else if ( !t2aOK && !SpellHelper.CheckTravel( Caster, map, loc, TravelCheckType.RecallTo ) )
			{
			}
