...
namespace Server.Spells.Fourth
{
	public class ManaDrainSpell : MagerySpell
	{
        ...
        public static void DoEffect(Mobile Caster, Mobile m, int Circle)
        {
            SpellHelper.Turn(Caster, m);

            SpellHelper.CheckReflect(Circle, Caster, ref m);
            ...
            {
                if (CheckResistedEasyStatic(m, Circle))
		...
		public void Target( Mobile m )
		{
			...
			{
                DoEffect(Caster, m, (int)this.Circle);
			}
