...
namespace Server.Commands
{
	public class Docs
	{
		...
		{
			World.Broadcast( 0x34, true, "Documentation is being generated, please wait." );
			...
			if( generated )
			{
				World.Broadcast( 0x34, true, "Documentation has been completed. The entire process took {0:F1} seconds.", (endTime - startTime).TotalSeconds );
				Console.WriteLine( "Documentation complete." );
			}
			else
			{
				World.Broadcast( 0x34, true, "Docmentation failed: Documentation directories are locked and in use. Please close all open files and directories and try again." );
