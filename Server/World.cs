 ...
 *
 *   $Id: World.cs 164 2007-04-20 22:35:41Z krrios $
 *
 ***************************************************************************/
...
namespace Server {
	public static class World {
		...
		public static void Save( bool message ) {
			...
			if ( message )
				Broadcast( 0x34, true, "The world is saving, please wait." );
			...
			if ( message )
				Broadcast( 0x34, true, "World save complete. The entire process took {0:F1} seconds.", watch.Elapsed.TotalSeconds );
