 ...
 *
 *   $Id: Container.cs 239 2007-09-13 09:19:23Z asayre $
 *
 ***************************************************************************/
...
namespace Server.Items
{
	...
	public class Container : Item
	{
		...
		{
			if ( from.AccessLevel > AccessLevel.Player || ( from.InRange( this.GetWorldLocation(), 2 ) && from.InLOS( this.GetWorldLocation() ) ) )
				DisplayTo( from );
			else
				from.SendLocalizedMessage( 500446 ); // That is too far away.
		}
