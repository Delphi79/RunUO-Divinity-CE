 ...
 *
 *   $Id: Mobile.cs 268 2007-11-27 06:38:14Z mark $
 *
 ***************************************************************************/
...
namespace Server
{
	...
	public class Mobile : IEntity, IHued, IComparable<Mobile>, ISerializable
	{
		...
		{
            // only context menu on yourself
            //if ( target is Mobile )
            //    return target == this;

            // item context menus for staff only
		...
		public virtual void Kill()
		{
			...
			//DropHolding(); // handling of this was moved to below
		...
		public virtual bool CanSee( Mobile m )
		{
			...
			return this == m || (
				m.m_Map == m_Map &&
				(!m.Hidden || (m_AccessLevel != AccessLevel.Player && (m_AccessLevel >= m.AccessLevel || m_AccessLevel == AccessLevel.Owner))) &&
		...
		public virtual bool ClickTitle { get { return false; } }

		public virtual bool PropertyTitle { get { return m_OldPropertyTitles ? ClickTitle : true; } }

		private static bool m_DisableHiddenSelfClick = false;
		...
		public virtual void OnSingleClick( Mobile from )
		{
            ...
            if (Frozen || (Spell != null && Spell.IsCasting) || (CantWalk && !CanSwim))
            {
                if (suffix.Length > 0)
                    suffix += " ";
                suffix += "(frozen)";
